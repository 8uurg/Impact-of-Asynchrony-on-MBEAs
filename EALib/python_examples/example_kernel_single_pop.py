...
criterion = ealib.DominationObjectiveAcceptanceCriterion(objective_indices)
...
gomea = ealib.KernelGOMEA(population_size, number_of_clusters, objective_indices, init, foslearner, criterion, archive)
# linkagekernels = True
